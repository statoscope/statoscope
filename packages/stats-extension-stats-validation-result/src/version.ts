export const name = '@statoscope/stats-extension-stats-validation-result';
export const version = '5.7.0';
export const description = 'Statoscope extension that collects stats validation result';
