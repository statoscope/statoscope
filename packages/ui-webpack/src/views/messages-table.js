                    ...
                    content: [
                      {
                        view: 'link',
                        data:
                          '{ href:"#asset:" + hash.encodeURIComponent(), text: $.path, match: #.filter }',
                        content: 'text-match',
                      },
                    ],
                  },
                    ...
                    content: [
                      {
                        view: 'link',
                        data:
                          '{ href:"#bundle:" + $.name.encodeURIComponent(), text: $.name, match: #.filter }',
                        content: 'text-match',
                      },
                    ],
                  },
                    ...
                    content: [
                      {
                        view: 'link',
                        data:
                          '{ href:"#chunk:" + $.id.encodeURIComponent(), text: $.name, match: #.filter }',
                        content: 'text-match',
                      },
                    ],
                  },
